...
1. [**__rnet-p2p__**](https://github.com/rnet-stack/rnet-p2p) *(Rust)*: An experimental p2p networking stack for understanding rust and internal p2p mechanics.
    ...
    **Used by:**
    ...
    - [**__rnet-inference__**](https://github.com/rnet-stack/rnet-inference): A peer-to-peer swarm inference engine for **Small Language Models**, built on top of **_rnet-p2p._**

---

2. [**__P2P-Federated-Learning__**](https://github.com/lla-dane/P2P-Federated-Learning) *(Python)*:- A p2p federated learning stack built with **py-libp2p, Akave-O3 and Hedera hashgraph**.
...
3. [**__LoyaltyX__**](https://github.com/lla-dane/LoyaltyX) *(Python, Rust, AI-agents)*:- An agentic AI-driven decentralized loyalty program platform on the Near blockchain.
...
4. [**__Tx-Validator__**](https://github.com/lla-dane/Tx-Validator) *(Rust)*:- A Bitcoin transaction validation and block mining script from scratch in Rust.
...
## Hackathon Wins:
- **__P2P-Federated-Learning__** *(Python)*: A p2p federated learning platform build using py-libp2p, Akave O3 and Hedera Hashgraph. ***Won the Akave track (Filecoin bounty) at ETHGlobal NewDelhi'25***.
	- *Showcase: https://ethglobal.com/showcase/p2p-fed-learning-ba4m0*
	- *Repo: https://github.com/lla-dane/P2P-Federated-Learning*

---
	
- **__Crowdnet__** *(Rust)*: A decentralized event hosting plaform on the Vara Blockchain. ***Won the 1st prize in the beginner track in the Gear Mega Hackathon'25.*** 
	- *Twitter post: https://x.com/lla_dane/status/1879907556778475966*
	- *Repo: https://github.com/karankoder/CrowdNet*

---
	
- __**LendingSapphire**__: *(Solidity)* A private lending plaform leveraging on-chain and off-chain confedentiality leveraging Oasis's ROFL secure execution environments. ***Won the 2nd prize in the Oasis bounty at ETHGlobal Singapore'24.***
	- *Showcase: https://ethglobal.com/showcase/lendingsapphire-jrbsc*
	- *Repo: https://github.com/bhaveshg16/Lending-Sapphire*

---
	
-  __**FairBET**__: *(Python)* A security layer based on nillion's lind computation to mitigate malicious final result modifications, in online betting plaforms like Roulette, built over a decentralised roulette plaform. ***Won the 2nd prize in the Nillion Bounty at ETHOnline'24.***
	- *Showcase: https://ethglobal.com/showcase/fairbet-ejims*
	- *Repo: https://github.com/aaravm/FairBET*

---
	
-  **__InstaClaim__** *(JavaScript)*: An instant insurance claim platform using CDP Agent kit + Lit Protocol (for decentralized encrypt/decrypt). ***Won a pool prize in the Lit Protocol bounty it ETHIndia'24.***
